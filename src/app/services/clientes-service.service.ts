...
export class ClientesServiceService {
  ...
  public sendGetClientes(): Observable<any> {
    ...
    return this.httpClient.get(this.url + '/RESTful/webresources/generic/all');
  }

  public sendGetCliente(id: number, parametros?: any): Observable<any> {
    console.log('entro a sendGetCliente');
    return this.httpClient.get(this.url + '/RESTful/webresources/generic/all/' + id, {params: parametros});
  }
  ...
  public sendPostCliente(cliente: ICliente): Observable<any> {
    ...
    return this.httpClient.post(this.url + '/RESTful/webresources/generic/add/', cliente);
  }

  public sendPutCliente(cliente: ICliente): Observable<any> {
    return this.httpClient.put(this.url + '/RESTful/webresources/generic/', cliente);
  }

  public sendDeleteCliente(id: number): Observable<any> {
    return this.httpClient.delete(this.url + '/RESTful/webresources/generic/' + id);
  }

  // ultimo folio
  public sendGetFolioClienteU(): Observable<any> {
    return this.httpClient.get(this.url + '/RESTful/webresources/generic/last');
  }
